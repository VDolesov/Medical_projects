                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: user.role == 'admin' ? Colors.red.shade100 : Colors.green.shade100,
                            borderRadius: BorderRadius.circular(20),
                          ),
                          child: Text(
                            user.role == 'admin' ? 'Администратор' : 'Врач',
                            style: TextStyle(
                              color: user.role == 'admin' ? Colors.red.shade700 : Colors.green.shade700,
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Имя пользователя скопировано'), duration: Duration(seconds: 1)),
                          );
                        },
                      ),
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Email скопирован'), duration: Duration(seconds: 1)),
                          );
                        },
                      ),
                      const Divider(height: 1),
